...
$query1="UPDATE nuke_eoy_votes SET MVP_1 = '$MVP1' WHERE team_name = '$Team_Name'";
$result1=mysql_query($query1);

$query2="UPDATE nuke_eoy_votes SET MVP_2 = '$MVP2' WHERE team_name = '$Team_Name'";
$result2=mysql_query($query2);

$query3="UPDATE nuke_eoy_votes SET MVP_3 = '$MVP3' WHERE team_name = '$Team_Name'";
$result3=mysql_query($query3);

$query4="UPDATE nuke_eoy_votes SET Six_1 = '$Six1' WHERE team_name = '$Team_Name'";
$result4=mysql_query($query4);

$query5="UPDATE nuke_eoy_votes SET Six_2 = '$Six2' WHERE team_name = '$Team_Name'";
$result5=mysql_query($query5);

$query6="UPDATE nuke_eoy_votes SET Six_3 = '$Six3' WHERE team_name = '$Team_Name'";
$result6=mysql_query($query6);

$query7="UPDATE nuke_eoy_votes SET ROY_1 = '$ROY1' WHERE team_name = '$Team_Name'";
$result7=mysql_query($query7);

$query8="UPDATE nuke_eoy_votes SET ROY_2 = '$ROY2' WHERE team_name = '$Team_Name'";
$result8=mysql_query($query8);

$query9="UPDATE nuke_eoy_votes SET ROY_3 = '$ROY3' WHERE team_name = '$Team_Name'";
$result9=mysql_query($query9);

$query10="UPDATE nuke_eoy_votes SET GM_1 = '$GM1' WHERE team_name = '$Team_Name'";
$result10=mysql_query($query10);

$query11="UPDATE nuke_eoy_votes SET GM_2 = '$GM2' WHERE team_name = '$Team_Name'";
$result11=mysql_query($query11);

$query12="UPDATE nuke_eoy_votes SET GM_3 = '$GM3' WHERE team_name = '$Team_Name'";
