...
$rosterspots=15;
    ...
    echo "<table border=1 cellspacing=0><tr><td align=center colspan=31><img src=\"http://www.iblhoops.net/online/teamgrfx/$userteam.jpg\"></td></tr>
";
...
if ($rookieextensioneligible == 1) {
  echo "<a href=\"http://www.iblhoops.net/modules.php?name=Free_Agency&pa=rookieoption&pid=$pid\">Rookie Option</a>";
}

if ($rookiemigration == 1) {
  echo "<a href=\"http://www.iblhoops.net/modules.php?name=Free_Agency&pa=positionmigration&pid=$pid\">Migrate Position</a>";
}
...
echo "                <tr bgcolor=#cc0000><td colspan=7><font color=white><b>Remaining Soft Cap Space Year 1:</b> $softcap </font></td><td colspan=12><font color=white><b>Remaining Hard Cap Space Year 1: </b>$hardcap </font></td><td colspan=12><font color=white><b>Remaining Roster Slots: </b>$rosterspots </font></td></tr>";
echo "                <tr bgcolor=#cc0000><td colspan=7><font color=white><b>Remaining Soft Cap Space Year 2:</b> $softcap2 </font></td><td colspan=12><font color=white><b>Remaining Hard Cap Space Year 2: </b>$hardcap2 </font></td><td colspan=12><font color=white><b>Remaining Roster Slots: </b>$rosterspots </font></td></tr>";
echo "                <tr bgcolor=#cc0000><td colspan=7><font color=white><b>Remaining Soft Cap Space Year 3:</b> $softcap3 </font></td><td colspan=12><font color=white><b>Remaining Hard Cap Space Year 3: </b>$hardcap3 </font></td><td colspan=12><font color=white><b>Remaining Roster Slots: </b>$rosterspots </font></td></tr>";
echo "                <tr bgcolor=#cc0000><td colspan=7><font color=white><b>Remaining Soft Cap Space Year 4:</b> $softcap4 </font></td><td colspan=12><font color=white><b>Remaining Hard Cap Space Year 4: </b>$hardcap4 </font></td><td colspan=12><font color=white><b>Remaining Roster Slots: </b>$rosterspots </font></td></tr>";
echo "                <tr bgcolor=#cc0000><td colspan=7><font color=white><b>Remaining Soft Cap Space Year 5:</b> $softcap5 </font></td><td colspan=12><font color=white><b>Remaining Hard Cap Space Year 5: </b>$hardcap5 </font></td><td colspan=12><font color=white><b>Remaining Roster Slots: </b>$rosterspots </font></td></tr>";
echo "                <tr bgcolor=#cc0000><td colspan=7><font color=white><b>Remaining Soft Cap Space Year 6:</b> $softcap6 </font></td><td colspan=12><font color=white><b>Remaining Hard Cap Space Year 6: </b>$hardcap6 </font></td><td colspan=12><font color=white><b>Remaining Roster Slots: </b>$rosterspots </font></td></tr>";

echo "                <tr bgcolor=#cc0000><td colspan=31><font color=white><b>";
...
echo "<img align=left src=\"http://www.iblhoops.net/images/player/$pid.jpg\">";
...
<form name=\"FAOffer\" method=\"post\" action=\"http://www.iblhoops.net/freeagentoffer.php\">
...
<input type=\"hidden\" name=\"vetmin\" value=\"$vetmin\">
<input type=\"submit\" value=\"120\"></form></td>
<td colspan=6></td></tr>";
}
...
echo "<form name=\"FAOfferDelete\" method=\"post\" action=\"http://www.iblhoops.net/freeagentofferdelete.php\">
...
<form name=\"Migrate\" method=\"post\" action=\"http://www.iblhoops.net/migrate.php\">
<input type=\"hidden\" name=\"teamname\" value=\"$userteam\">
<input type=\"hidden\" name=\"playername\" value=\"$player_name\">
<select name=\"NewPos\">
";
  ...
  if ($eligible_PG == 1) {
    if ($player_base_pos == 'PG') {
    echo "  <option SELECTED value=\"PG\">PG</option>
";
    } else {
...
";
  ...
  if ($eligible_SF == 1) {
    if ($player_base_pos == 'SF') {
    echo "  <option SELECTED value=\"SF\">SF</option>
";
    } else {
...
";
  ...
  if ($eligible_PF == 1) {
    if ($player_base_pos == 'PF') {
    echo "  <option SELECTED value=\"PF\">PF</option>
";
    } else {
...
echo "<center><h1>Cap Space and Roster Spots for all teams</h1>
</center>
...
echo "
                <tr><td>$capteam</td><td>$softcap</td><td>$hardcap</td><td>$rosterspots</td>";
