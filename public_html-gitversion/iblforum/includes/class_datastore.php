...
*
* @package	vBulletin
* @version	$Revision: 42199 $
* @date		$Date: 2011-03-23 12:19:41 -0700 (Wed, 23 Mar 2011) $
*/
...
class vB_Datastore_Memcached extends vB_Datastore
{
	...
	*/
	function fetch($items)
	{
		...
		//this line must stay under the potential return statement above.  In general we must
