...
//  if ($player_team_name == $userteam) {
//echo "<table align=right bgcolor=#ffff00><tr><td align=center><a href=\"modules.php?name=Player&pa=poschange&pid=$pid\">CHANGE<BR>POSITION</a></td></tr></table>";
//  } else {
//  }
//} else {
//}
...
if ($fa_active == 1)
{
echo "Sorry, the position change extension feature is not available during free agency.";
} else {

echo "<form name=\"ExtensionOffer\" method=\"post\" action=\"poschange.php\">";
...
//if ($player_pos = SG) {
//echo "<INPUT TYPE=\"text\" NAME=\"newpos\" SIZE=\"4\" VALUE=\"$player_pos\"></td></tr>
//";
//}
...
//echo "<INPUT TYPE=\"text\" NAME=\"newpos\" SIZE=\"4\" VALUE=\"$player_pos\"></td></tr>
//";
//echo "<INPUT TYPE=\"checkbox\" NAME=\"food[]\" SIZE=\"4\" VALUE=\"Steak\">Steak:</td></tr>
//";
...
echo "<tr><td colspan=6><b>Notes/Reminders:</b> <ul>
<li>You are limited to a maximum of 5 position changes per season. You have used $poschanges changes.</li>
<li>Players are only able to slide up or down 2-3 positions.</li>
";
echo "
</ul></td></tr>
<input type=\"hidden\" name=\"dem1\" value=\"$dem1\">
