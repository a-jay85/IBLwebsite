...
define("_LASTVISIT","Sinu viimane foorumi külastus oli ");
define("_TYPES","Preferences");
define("_FTOPICS","Arutelu");
define("_FPOSTS","Sõnumid");
define("_FLPOSTS","Viimane sõnum");
define("_PMSG","Privaatsed sõnumid");
define("_PINBOX","Postkast");
define("_LOGINTOR","Sa pead uudiste lugemiseks sisse logima.");
define("_VNMS","Uued Sõnumid");
define("_VNM","Uued Sõnumid");
define("_TVM","Kõik Sõnumid");
define("_NPM","Sul ei ole salvestunud sõnumeid");
define("_NPO","Sul on viimasest külastusest uued sõnumid");
define("_NNPO","Sinu viimasest külastusest pole uusi sõnumeid");
define("_FFA","Free to all");
define("_FREG","Registreeritud kasutajad");
define("_FMODS","Moderaator");
define("_PASSW","Salasõnaga kaitstud");
...
define("_FODATE","Kuupäev");
define("_FNOTOPICS","Selles foorumis pole uusi teemasi");
define("_FPOSTONE","Soovikorral võid postitada uue teema.");
define("_FNEXTP","Järgmine leht");
define("_JUMPTO","Hüppa");
define("_FSELECTF","Vali Foorum");
define("_TLOCKED","Arutelu lõpetatud-Teema on suletud");
...
define("_FPOSTED","Uus sõnum on postitatud!");
...
define("_FPASSWORD","Salasõna");
define("_FSUBJECT","Teema");
define("_FMESSAGE","Sõnum");
define("_FMICON","Sõnumi ikoon");
define("_FON","sees");
define("_FOFF","väljas");
define("_FOPTIONS","Seaded");
define("_DISHTML","HTML pole selles sõnumis lubatud");
define("_FDIS","Pole lubatud");
define("_FTHISMAIL","selles sõnumis");
...
define("_FDELT","Tühista teema");
define("_FJOINED","Registered to :");
define("_FAPOSTS","Sõnumid :");
define("_FFROM","Da");
...
define("_DISCTOT","Üldine arutelu");
define("_FMESS","Messaggi!");
