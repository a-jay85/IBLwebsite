...
if ($boards_type == 'Reg')
{
echo "  <option value=\"Reg\" SELECTED>Regular Season</option>
";
} else {
echo "  <option value=\"Reg\">Regular Season</option>
";
}

if ($boards_type == 'Ply')
{
echo "  <option value=\"Ply\" SELECTED>Playoffs</option>
";
} else {
echo "  <option value=\"Ply\">Playoffs</option>
";
}

//if ($boards_type == 'Wld')
//{
//echo "  <option value=\"Wld\" SELECTED>World Championships</option>
//";
//} else {
//echo "  <option value=\"Wld\">World Championships</option>
//";
//}
...
//  if ($boards_type == 'Wld')
//  {
//  $tableforquery="ibl_worlds_totals";
//  $restriction2="games > 0";
//  }
...
<tr><th><center>Rank</th></center><th><center>Name</center></th><th><center>Gm</center></th><th><center>Min</center></th><th><center>FGM</a></center></th><th><center>FGA</center></th><th><center>FTM</center></th><th><center>FTA</center></th><th><center>3PTM</center></th><th><center>3PTA</center></th><th><center>ORB</center></th><th><center>REB</center></th><th><center>AST</center></th><th><center>STL</center></th><th><center>TVR</center></th><th><center>BLK</center></th><th><center>FOULS</center></th><th><center>PTS</center></th></tr>
";
...
//if ($tableforquery == "ibl_worlds_totals")
//{
//$plyr_name=mysql_result($result,$i,"name");
//$pid=mysql_result($result,$i,"pid");
...
echo "</center></td><td><center>$gm</center></td><td><center>$min</center></td><td><center>$fgm</center></td><td><center>$fga</center></td><td><center>$ftm</center></td><td><center>$fta</center></td><td><center>$tgm</center></td><td><center>$tga</center></td><td><center>$orb</center></td><td><center>$reb</center></td><td><center>$ast</center></td><td><center>$stl</center></td><td><center>$to</center></td><td><center>$blk</center></td><td><center>$pf</center></td><td><center>$pts</center></td></tr>";
...
@$hist_tgp=($hist_tgm/$hist_tga);
    ...
    $hist_pts = $hist_fgm+$hist_fgm+$hist_ftm+(3*$hist_tgm);
