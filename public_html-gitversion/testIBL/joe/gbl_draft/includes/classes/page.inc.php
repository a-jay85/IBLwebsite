...
<div class="top_menu">
  <ul>';
      ...
      $html .= '
    <li><a href="javascript:popup(\'http://gbl.iblhoops.net/modules.php?name=College_Scouting\', \'scouting\', 800, 400)">Draft Scouting</a></li>';
      if ($login->team_id()) {
	$html .= '
...
limit 1";
	...
	$_SESSION['dinged_pick'][$row['pick_id']] = $_SESSION['dinged_pick'][$row['pick_id']] + 1;
      ...
      $html .= '
On the clock: '.$row['team_name'].' (round '.ceil(($row['pick_id'])/27).', pick '.$pick.',
